...
class NewBatchDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        field_sizer.Add(wx.StaticText(self, label='Name:', size=(65, -1)), 0, wx.RIGHT + wx.ALIGN_LEFT, 5)
        ...
        # Files
        self.files = list()
        self._files = wx.ListCtrl(self, wx.ID_ANY, style=wx.LC_REPORT)
